const $form = document.querySelector('#calculadora-sueldos')
...
document.querySelector('#calcular-sueldos').onclick = function(event) {
    ...
    if(esExito) {
        ...
        mostrarElemento('#calculos-sueldos');
    }
}

document.querySelector('#resetear-sueldos').onclick = resetear;

function crearInterfaces(cantidadPersonas) {
    if (cantidadPersonas > 0) {
        mostrarElemento('#calcular-sueldos');
    } else {
        resetear();
    }
...
function resetear() {
    ...
    ocultarElemento('#calcular-sueldos');
}
